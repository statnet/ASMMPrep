...
trans.mard <- function(dat, at){
  ...
  # PrEP
  trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "n")] <-
            trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "n")] * (1 - pce[1])
  trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "l")] <-
            trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "l")] * (1 - pce[2])
  trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "m")] <-
            trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "m")] * (1 - pce[3])
  trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "h")] <-
            trans.ip.prob[which(ip.prep == 1 & ip.prepcl == "h")] * (1 - pce[4])
